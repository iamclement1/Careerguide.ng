  ...
  return (
    <div className="BodySection">
      ...
      <p>
        ...
        simply need you to be willing and dedicated.
      </p>
      <p>
        We help in providing University admission seekers with the required
        information, materials, guidance and all necessary resources in order to
        ensure they have a better and seameless experience starting their career
        sojourn.
      </p>
      ...
      <p>
        ...
        <a href="">youthsandcareer</a>) indicating your interest and background.
        Also, tell us what you would bring to Youths and Careers if hired.
      </p>
    </div>
  );
};
